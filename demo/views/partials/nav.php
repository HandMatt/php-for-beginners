...
/**
 * Navigation Partial
 * Appears at top of every page below head
 * Contains main site navigation and dynamic active state
 */
?>
...
<nav class="bg-gray-800">
      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            <!-- Navigation Links (Notes only visible to authenticated users) -->
          ...
          <?php if ($_SESSION['user'] ?? false) : ?>
            <div class="ml-3">
              <form action="/session" method="POST">
                ...
                <button type="submit" class="rounded-md bg-gray-800 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Log Out</button>
              </form>
            </div>
          <?php endif; ?>
        </div>
  ...
  <div class="md:hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
      <!-- Navigation Links -->
      <a href="/" class="<?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> block px-3 py-2 rounded-md text-base font-medium">Home</a>
      ...
      <a href="/notes" class="<?= urlIs('/notes') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> block px-3 py-2 rounded-md text-base font-medium">Notes</a>
